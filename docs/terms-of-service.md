...
- Upon termination, active quiz sessions are deleted when their associated PRs are closed or by our regular cleanup process. Quiz attempt records may be retained for auditing purposes per our [Privacy Policy](./privacy-policy.md).
