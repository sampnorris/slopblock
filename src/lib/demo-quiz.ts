  ...
  questions: [
    {
      ...
      options: [
        { key: "A", text: "An answers object keyed by question ID must be present in the request body." },
      ...
      correctOption: "A",
      explanation: "The route now rejects requests that do not include an answers object for grading.",
    ...
    },
    {
      ...
      options: [
        { key: "A", text: "So grading errors can be turned into a 400 JSON response instead of crashing the request." },
      ...
      correctOption: "A",
      explanation: "Validation and grading failures are returned as explicit client-visible errors with status 400.",
      diffAnchors: ["src/routes/api/session/[token]/answer/+server.ts"],
    },
    {
      id: "q3",
      ...
      options: [
        { key: "A", text: "They now fail fast with an error message instead of slipping through to grading." },
        { key: "B", text: "They automatically generate default answers for the missing questions." },
        { key: "C", text: "They are accepted, but the score is capped at 50 percent." },
      ],
      correctOption: "A",
      explanation: "The new guard stops incomplete payloads before grading and reports the problem clearly.",
      diffAnchors: ["src/routes/api/session/[token]/answer/+server.ts"],
    },
